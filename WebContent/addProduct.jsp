    ...
    <div id="wrapper">
    		...
    		<form action="AddProductServlet" method="post" enctype="multipart/form-data">
                				<div class="row">
                					...
                					<div class="col-md-4">
                						<input type="text" class="form-control" name="productName" style="text-align:left;">
                					</div>
                				...
                				<div class="row">
                					...
                					<div class="col-md-4">
                						<input type="text" class="form-control" name="productDesc" style="text-align:left;">
                					</div>
                					<div class="col-md-5"></div>
                				</div><br/><br/>
                				...
                				<div class="row">
                					...
                					<div class="col-md-4">
                						<input type="text" class="form-control" name="price" style="text-align:left;">
                					</div>
                					<div class="col-md-5"></div>
                				</div><br/><br/>
                				...
                				<div class="row">
                					...
                					<div class="col-md-4">
                						<input type="text" class="form-control" name="b2bPrice" style="text-align:left;">
                					</div>
                					<div class="col-md-5"></div>
                				</div><br/><br/>
                				...
                				<div class="row">
                					...
                					<div class="col-md-4">
                						<input type="text" class="form-control" name="b2bQty" style="text-align:left;">
                					</div>
                					<div class="col-md-5"></div>
                				</div><br/><br/>
