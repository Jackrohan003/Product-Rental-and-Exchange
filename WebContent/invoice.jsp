...
<!-- Mirrored from binarytheme.com/BTlivedemos/2014/09/16/advance-admin/invoice.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 22 Aug 2018 10:46:41 GMT -->
<head>
    <meta charset="utf-8" />
                     ...
                     <li>
                        <a class="active-menu-top" href="#"><i class="fa fa-yelp "></i>Extra Pages <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
                            <li>
                                <a class="active-menu" href="invoice.jsp"><i class="fa fa-coffee"></i>Invoice</a>
                            </li>
                            <li>
...
<!-- Mirrored from binarytheme.com/BTlivedemos/2014/09/16/advance-admin/invoice.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 22 Aug 2018 10:46:42 GMT -->
</html>
