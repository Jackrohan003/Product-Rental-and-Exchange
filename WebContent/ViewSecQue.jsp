...
<head>
    ...
    <title>View Security Question</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">VIEW SECURITY QUESTION</h1>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <!--                 <th>ISACTIVE</th>
                                ...
                                <tbody>
                                <%
                                	List<SecurityQuestion> l = SecurityQuestionOperation.getAll();
                                
                                	for(SecurityQuestion s : l)
                                	{
                                %>
                                    <tr>
                                        <td><%= s.getQuestion()%></td>
