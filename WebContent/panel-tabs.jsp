...
<!-- Mirrored from binarytheme.com/BTlivedemos/2014/09/16/advance-admin/panel-tabs.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 22 Aug 2018 10:46:37 GMT -->
<head>
    <meta charset="utf-8" />
                    ...
                    <li>
                        <a href="#"  class="active-menu-top"><i class="fa fa-desktop "></i>UI Elements <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
                            <li>
                                <a class="active-menu" href="panel-tabs.jsp"><i class="fa fa-toggle-on"></i>Tabs & Panels</a>
                            </li>
                            <li>
