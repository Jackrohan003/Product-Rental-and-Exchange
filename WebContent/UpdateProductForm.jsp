  ...
  transition: all .2s ease;
    ...
    <div id="wrapper">
    		...
    		<form action="UpdateProductServlet" method="post" enctype="multipart/form-data">
                					...
                					<div class="col-md-4">
                						<input type="text" class="form-control" name="pid"  style="text-align:left;" value = "<%=p.getId() %>" readonly >
                					</div>
                				...
                				<div class="row">
                					...
                					<div class="col-md-4">
                						<input type="text" class="form-control" name="productName" style="text-align:left;" value = "<%=p.getName() %>"  >
                					</div>
                					<div class="col-md-5"></div>
                				</div><br/><br/>
                			...
                			<!-- 	<div class="row">
                				...
                				<div class="row">
                					...
                					<div class="col-md-4">
                						<input type="text" class="form-control" name="productDesc" style="text-align:left;" value = <%=p.getDescription() %>>
                					</div>
                					<div class="col-md-5"></div>
                				</div><br/><br/>
                				...
                				<div class="row">
                					...
                					<div class="col-md-4">
                						...
                						<%	
                							List<Category> list = CategoryOperation.getAll(); 
                							for(Category c:list)
                							{
                								if(c.getCategoryid() == p.getCid())
                								{
                								%>
                				...
                				<div class="row">
                					...
                					<div class="col-md-4">
                						<input type="text" class="form-control" name="price" style="text-align:left;"value = <%=p.getPrice() %>>
                					</div>
                					<div class="col-md-5"></div>
                				</div><br/><br/>
                				...
                				<div class="row">
                					...
                					<div class="file-upload" id="file-upload1">
  									<div class="image-upload-wrap" id="image-upload-wrap1">
    										<input class="file-upload-input" id="file-upload-input1" type='file' name="image1" onchange="readURL1(this);" accept="image/*"/>
    										<div class="drag-text">
      											<h3>Image 1</h3>
    										</div>
  									</div>
                					...
                					<div class="file-upload" id="file-upload2">
  									<div class="image-upload-wrap" id="image-upload-wrap2">
    										<input class="file-upload-input" id="file-upload-input2" type='file' name="image2" onchange="readURL2(this);" accept="image/*"/>
    										<div class="drag-text">
      											<h3>Image 2</h3>
    										</div>
  									</div>
                					...
                					<div class="file-upload" id="file-upload3">
  									<div class="image-upload-wrap" id="image-upload-wrap3">
    										...
    										<input type="hidden" name="image3rem" id="file-upload-input-rem3">
    										<div class="drag-text">
                					...
                					<div class="file-upload" id="file-upload4">
  									<div class="image-upload-wrap" id="image-upload-wrap4">
    										...
    										<input type="hidden" name="image4rem" id="file-upload-input-rem4">
    										<div class="drag-text">
                				...
                				<div class="row">
                					...
                					<%-- <div class="col-md-4">
                						<input type="text" class="form-control" value="<%=p.getB2bPrice() %>" name="b2bPrice" style="text-align:left;">
                					</div>
                					<div class="col-md-5"></div>
                				</div><br/><br/>
                				...
                				<div class="row">
                					...
                					<div class="col-md-4">
                						<input type="text" class="form-control" name="b2bQty" value="<%=p.getB2bQuantity() %>" style="text-align:left;">
                					</div> --%>
                					<div class="col-md-5"></div>
                				</div><br/><br/>
                				...
                				<div class="row">
                					...
                					<div class="col-md-6">
                					<%-- 	<input type="hidden" name="id" value="<%= p.getProductId()%>"></input> --%>
                						<input type="submit" class="btn btn-primary" value="Update Product" style="font-size:16px;padding:10px;width:35%;border-radius: 4px;border-bottom: 4px solid #217dbb;transition: all .2s ease;">
                					</div>
                					<div class="col-md-3"></div>
                				</div>
                				</form>
    ...
    $(document).ready(function(){
    	...
    	$("#file-upload-image1").attr('src',"<%= p.getImage1()%>");
    	$("#remove-image1").prop('disabled', false);
    	$('#image-upload-wrap1').hide();
     	$('#file-upload-content1').show();
    		$('#file-upload-btn1').hide();
    			   		
    		$("#file-upload-image2").attr('src',"<%= p.getImage2()%>");
    	$("#remove-image2").prop('disabled', false);
    	$('#image-upload-wrap2').hide();
    	$('#file-upload-content2').show();
    		$('#file-upload-btn2').hide();
    	
    		var img3 = "<%= p.getImage3() %>";
    	if(img3 == "null")
    	{
    		$('#image-upload-wrap3').show();
    		$('#file-upload-content3').hide();
    	...
    	{
    		$("#file-upload-image3").attr('src',"<%= p.getImage3()%>");
    		$("#remove-image3").prop('disabled', false);
    		$('#image-upload-wrap3').hide();
    		$('#file-upload-content3').show();
    		$('#file-upload-btn3').hide();
    	}
    	...
    	{
    		$("#file-upload-image4").attr('src',"<%= p.getImage4()%>");
    		$("#remove-image4").prop('disabled', false);
    		$('#image-upload-wrap4').hide();
    		$('#file-upload-content4').show();
    		$('#file-upload-btn4').hide();	
    	}
