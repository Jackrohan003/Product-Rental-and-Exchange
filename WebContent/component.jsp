...
<!-- Mirrored from binarytheme.com/BTlivedemos/2014/09/16/advance-admin/component.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 22 Aug 2018 10:46:43 GMT -->
<head>
    <meta charset="utf-8" />
                        ...
                        <a class="active-menu-top" href="#"><i class="fa fa-yelp "></i>Extra Pages <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
                            ...
                            <li>
                             ...
                             <li>
                                <a class="active-menu" href="component.jsp"><i class="fa fa-key "></i>Components</a>
                            </li>
                             <li>
