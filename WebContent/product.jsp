...
<!-- Mirrored from binarytheme.com/BTlivedemos/2014/09/16/advance-admin/table.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 22 Aug 2018 10:46:44 GMT -->
<head>
    <meta charset="utf-8" />
    ...
    <div id="wrapper">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-desktop "></i>Manage User <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level">
                            <li>
                                <a href="adduser.jsp"><i class="fa fa-toggle-on"></i>Add User</a>
                            </li>
                            <li>
                     ...
                     <li>
                        <a  class="active-menu" href="product.jsp"><i class="fa fa-flash "></i>Product</a>
                    </li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line"> Table</h1>
