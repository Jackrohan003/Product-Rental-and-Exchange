...
<div class="container">
	<div class="row">
        ...
        <div class="col-md-6">
            <form action="../ChangePasswordServletU" method="post" id="fileForm" onsubmit="return check(0);" onchange="return check(1);" role="form">
            <fieldset><legend class="text-center" style="color:red;"><h1><center>Change Password</center></h1></legend>
			  <div class="form-group">
                <label for="password"><span class="req" style="color:red">* </span>Old Password: </label>
                    <input name="oldpassword" type="password" class="form-control inputpass" minlength="4" maxlength="24"  id="oldpass" placeholder="Enter old Password" /> 
					  <i class="icon fa fa-check ic" id="roldpass"></i>
					  <i class="icon fa fa-times iw" id="woldpass"></i>
			</div>
            ...
            <div class="form-group">
                <input class="btn btn-success" type="submit" name="confirm_reg" value="Confirm Password" id="submit" style="background-color:blue;">
            </div>
...
function check(i){
	...
	var passo=document.getElementById("oldpass").value;
	if(pass1=="" && pass2=="" && passo==""){
		...
		return false;
			...
			if(passo==""){
				...
				document.getElementById("oldpass").style.border="2px solid green";
				$('#roldpass').show();
			}
			...
			if(i==0)
			{
				document.getElementById("oldpass").value = calcMD5(passo);
