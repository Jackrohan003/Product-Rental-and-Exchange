...
<input type="hidden" class="form-control" name="fromEmail" value="<%=user %>">
<input type="hidden" class="form-control" name="toEmail" value="<%=p.getEmail() %>">
...
<%
	...
	{
%>
<button class="btn btn-primary" style="padding-right:8px;padding-left:8px;">Chat</button>
<%
	}
%>
...
<div class="col-md-3">
	<figure class="card card-product">
		<a href="ExchangeDetails.jsp?id=<%=q.getId()%>" class="item-box">
