...
<head>
    ...
    <title>Add Product Exchange</title>
		 ...
		 $('#image-upload-wrap2').bind('dragover', function () {
			 ...
			 $('#image-upload-wrap3').bind('dragover', function () {
				 ...
				 $('#image-upload-wrap4').bind('dragover', function () {
		    		...
		    		function act()
		    		{
		    		alert("you must be logged on to add product");
		    		}
 ...
 <%
    ...
    %>
         ...
         <div style="margin-top:50px; margin-bottom:50px;">
    		<form action="../AddExchangeProductServlet" method="post" enctype="multipart/form-data">
                				<div class="row">
