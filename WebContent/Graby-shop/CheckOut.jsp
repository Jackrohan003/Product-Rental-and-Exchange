...
<tr>
			<th colspan="14"><h1>Product Rental And Exchange</h1></th>
		</tr>
...
%>
		...
		<tr>
			...
			<th colspan="4" style="text-align: right !important;">SUB TOTAL</th>
		...
		<tr>
			...
			<th colspan="12" style="text-align: right !important;">Packing Charges<br/>Delivery Charges<br/></th>
			<th colspan="2"  style="text-align: center !important;">200.00<br/>50.00<br/></th>
		</tr>
		
  		<tr>
   	 		<th colspan="12" style="text-align: right !important;">NET AMOUNT(Rounded off):-</th>
   	 		<th colspan="2"><% 	 out.println("<span id='amount'>"+Math.round(subTotal+250)+"</span>"+".0"); %></th>
  		</tr>

  		<tr>
  			<th colspan="14" style="text-align: left !important;">Amount in Words :- <span id="inwords"></span></th>
  		</tr>
