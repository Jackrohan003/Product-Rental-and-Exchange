...
<!-- Mirrored from binarytheme.com/BTlivedemos/2014/09/16/advance-admin/buttons.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 22 Aug 2018 10:46:37 GMT -->
<head>
    <meta charset="utf-8" />
                        ...
                        <a href="#"  class="active-menu-top"><i class="fa fa-desktop "></i>UI Elements <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level  collapse in">
                            ...
                            <li>
                             ...
                             <li>
                                <a class="active-menu" href="buttons.jsp"><i class="fa fa-code "></i>Buttons</a>
                            </li>
                             <li>
