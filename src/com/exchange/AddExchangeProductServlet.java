...
/**
 * Servlet implementation class AddExchangeProductServlet
 */
@WebServlet("/AddExchangeProductServlet")
@MultipartConfig
public class AddExchangeProductServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddExchangeProductServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(b) {
				response.sendRedirect("Graby-shop/exchage.jsp");
		}
		else
		{
			response.sendRedirect("Graby-shop/addProductExchange.jsp");
		}
