...
/**
 * Servlet implementation class AddRentProductServlet
 */
@WebServlet("/AddRentProductServlet")
@MultipartConfig
public class AddRentProductServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddRentProductServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(b) {
				response.sendRedirect("Graby-shop/rental.jsp");
		}
		else
		{
			response.sendRedirect("addProductOriginal.jsp");
		}
