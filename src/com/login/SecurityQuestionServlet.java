...
import com.jdbc.SecurityQuestionOperation;
...
public class SecurityQuestionServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String question = request.getParameter("seq_que");
		SecurityQuestion s = new SecurityQuestion();
		s.setQuestion(question);
		SecurityQuestionOperation.addQuestion(s);
		
		response.sendRedirect("ViewSecQue.jsp");
